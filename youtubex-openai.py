...
requirements: torch, torchvision, torchaudio, yt-dlp, imageio-ffmpeg, whisperx, pydantic, requests, langchain, langchain-community, langchain-openai, langchain-core, langchain-text-splitters, httpx
"""
